...
- [445](https://github.com/Shopify/job-iteration/pull/445) - Appends an iterate callback to job iterations. This adds extensibility to build some generic handlers, such as metrics collection and logging.
